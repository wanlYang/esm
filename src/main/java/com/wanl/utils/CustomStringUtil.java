...
public class CustomStringUtil {
     ...
     * @param base64Img
     */
    public static boolean base64StringToImage(StringBuffer base64Img,String toImagePath,String imageType) {
        try {
            BASE64Decoder decoder = new BASE64Decoder();
            ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(base64Img.toString().getBytes());
