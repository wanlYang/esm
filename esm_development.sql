...
Source Database       : esm_development

Target Server Type    : MYSQL
Target Server Version : 50624
File Encoding         : 65001

Date: 2019-03-01 09:36:00
*/
...
CREATE TABLE `esm_cart` (
  ...
  CONSTRAINT `esm_cart_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `esm_user` (`id`),
  CONSTRAINT `esm_cart_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `esm_product` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `esm_cate` (
  ...
  `display` int(11) DEFAULT '1' COMMENT '是否显示',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of esm_cate
-- ----------------------------
INSERT INTO `esm_cate` VALUES ('1', '0', '女装', '女士服装，汉服', '1');
INSERT INTO `esm_cate` VALUES ('2', '0', '男装', '男士服装，汉服', '1');
INSERT INTO `esm_cate` VALUES ('5', '0', '鞋靴', '鞋靴', '1');
INSERT INTO `esm_cate` VALUES ('15', '1', '襦裙', '襦，即短上衣，按款式分类，有对襟（亦称直领）、交领（亦称斜襟）、坦领（亦称U领）等；裙，即下裙，通常为一片式合围裙，按制作方式分类，分为褶裙、片裙等', '1');
...
CREATE TABLE `esm_collection` (
  ...
  KEY `user_id` (`user_id`) USING BTREE,
  KEY `product_id` (`product_id`) USING BTREE,
  CONSTRAINT `esm_collection_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `esm_user` (`id`),
  CONSTRAINT `esm_collection_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `esm_product` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of esm_collection
-- ----------------------------
...
CREATE TABLE `esm_order` (
  ...
  `confirm_date` datetime DEFAULT NULL COMMENT '收获日期',
  `status` int(11) DEFAULT NULL COMMENT '状态',
  `ordertotal` decimal(10,0) DEFAULT NULL COMMENT '总价',
  `address_id` int(11) DEFAULT NULL COMMENT '地址ID',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE,
  KEY `address_id` (`address_id`) USING BTREE,
  CONSTRAINT `esm_order_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `esm_user` (`id`),
  CONSTRAINT `esm_order_ibfk_2` FOREIGN KEY (`address_id`) REFERENCES `esm_address` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `esm_orderitem` (
  ...
  CONSTRAINT `esm_orderitem_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `esm_product` (`id`),
  CONSTRAINT `esm_orderitem_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `esm_user` (`id`),
  CONSTRAINT `esm_orderitem_ibfk_3` FOREIGN KEY (`order_id`) REFERENCES `esm_order` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `esm_product` (
  ...
  `main_title` varchar(255) DEFAULT NULL COMMENT '商品主标题',
  `
sub_title` varchar(255) DEFAULT NULL COMMENT '商品副标题',
  ...
  `is_hot` int(255) DEFAULT '0' COMMENT '是否热门',
  `stock` int(11) DEFAULT NULL COMMENT '库存',
  `shelf_time` datetime DEFAULT NULL COMMENT '上架时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `cate_id` (`cate_id`) USING BTREE,
  CONSTRAINT `esm_product_ibfk_1` FOREIGN KEY (`cate_id`) REFERENCES `esm_cate` (`id`)
...
CREATE TABLE `esm_product_img` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `product_id` (`product_id`) USING BTREE,
  CONSTRAINT `esm_product_img_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `esm_product` (`id`)
...
CREATE TABLE `esm_property` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `cate_id` (`cate_id`) USING BTREE,
  CONSTRAINT `esm_property_ibfk_1` FOREIGN KEY (`cate_id`) REFERENCES `esm_cate` (`id`)
...
CREATE TABLE `esm_propertyvalue` (
  ...
  CONSTRAINT `esm_propertyvalue_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `esm_product` (`id`),
  CONSTRAINT `esm_propertyvalue_ibfk_2` FOREIGN KEY (`property_id`) REFERENCES `esm_property` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `esm_review` (
  ...
  KEY `user_id` (`user_id`) USING BTREE,
  KEY `product_id` (`product_id`) USING BTREE,
  CONSTRAINT `esm_review_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `esm_user` (`id`),
  CONSTRAINT `esm_review_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `esm_product` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `esm_user` (
  ...
  `phone` varchar(255) NOT NULL COMMENT '绑定手机号',
  `email` varchar(255) DEFAULT NULL COMMENT '绑定邮箱',
  `headimg` varchar(255) DEFAULT NULL COMMENT '头像',
  `age` int(11) DEFAULT NULL COMMENT '年龄',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `username` (`username`) USING BTREE COMMENT '用户名唯一性',
  UNIQUE KEY `phone` (`phone`) USING BTREE COMMENT '用户手机号唯一性',
  UNIQUE KEY `email` (`email`) USING BTREE COMMENT '用户邮箱唯一性'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `esm_useraccount` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE,
  CONSTRAINT `esm_useraccount_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `esm_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
